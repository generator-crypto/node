...
import (
	...
	"github.com/generator-crypto/node/x/generator"
...
func getCliPath() string {
	if runtime.GOOS == "windows" {
		return os.ExpandEnv("$UserProfile/.generatorcli")
	}

	return os.ExpandEnv("$HOME/.generatorcli")
}

func getNodePath() string {
	if runtime.GOOS == "windows" {
		return os.ExpandEnv("$UserProfile/.generatord")
	}

	return os.ExpandEnv("$HOME/.generatord")
}
